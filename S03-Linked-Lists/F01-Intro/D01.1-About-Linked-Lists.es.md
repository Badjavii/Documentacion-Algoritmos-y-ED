...
*(Ahora en adelante, las ilustraciones ya no mostrarán direcciones de memoria sino solo muestras gráficas del comportamiento de las estructuras. Esto con el fin de optimizar la carga de trabajo para el administrador del repositorio.)*
