...
Luego se declará e inicializa un nuevo apuntador temporal `t` al que se le asigna un nuevo nodo de lista simple. A ese nodo le agregaremos el dato entero `x` que está como parámetro.
